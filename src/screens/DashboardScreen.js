      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.subtitle}>
            Your Smart and Easy Solution for Managing Bills and Quotations. Simplify your finances with just a few clicks.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  scrollContainer: { flexGrow: 1, justifyContent: "center", alignItems: "center", paddingVertical: height * 0.05, paddingHorizontal: width * 0.08 },
